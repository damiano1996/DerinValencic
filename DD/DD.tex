...
\input{main/glossary} % input definitions
...
\input{main/ArchitecturalDesign}
\input{main/UserInterfaceDesign}
\input{main/RequirementsTraceability}
\input{main/ImplementationIntegrationTestPlan}
\input{main/EffortSpent}
