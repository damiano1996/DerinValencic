...
\begin{figure}[H]
	...
	\subfigure[Log In page.]{\label{fig:LogInMockup}\includegraphics[width=0.4\textwidth]{images/log_in.png}}
	\subfigure[Sign Up page.]{\label{fig:SignUpMockup}\includegraphics[width=0.4\textwidth]{images/sign_up.png}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[Lining Up page.]{\label{fig:LiningUpMockup}\includegraphics[width=0.4\textwidth]{images/lining_up_01.png}}
	\subfigure[Booking Visit page.]{\label{fig:BookingVisitMockup}\includegraphics[width=0.4\textwidth]{images/booking_visit_01.png}}
	
	\subfigure[Lining Up page with expanded spinner.]{\label{fig:LiningUp2Mockup}\includegraphics[width=0.4\textwidth]{images/lining_up_02.png}}
	\subfigure[Booking Visit page with expanded spinner.]{\label{fig:BookingVisit2Mockup}\includegraphics[width=0.4\textwidth]{images/booking_visit_02.png}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[Get Status page.]{\label{fig:GetStatusMockup}\includegraphics[width=0.4\textwidth]{images/get_status.png}}
	\subfigure[Show QR code page.]{\label{fig:ShowQRMockup}\includegraphics[width=0.4\textwidth]{images/show_qr_code.png}}
