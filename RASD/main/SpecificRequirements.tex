...
\begin{tabular}{| m{0.2\textwidth} | m{0.8\textwidth} |} 
	...
	\textbf{Requirements} &
		\begin{itemize}
			...
			% req below is very similar to the goal! We should remove it...?
...
\begin{tabular}{| m{0.2\textwidth} | m{0.8\textwidth} |} 
	...
	\textbf{Requirements} &
		\begin{itemize}
			\item {\textbf{[R]}}: A physical spot shall be installed outside the store. % req (we are the installers...) or domain assumption?
